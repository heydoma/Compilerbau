...
/********************   DStructDer    ********************/
DStructDer::DStructDer(Id p1, Type *p2, ListField *p3)
{
  id_ = p1;
  type_ = p2;
  listfield_ = p3;
...
DStructDer::DStructDer(const DStructDer & other)
{
  id_ = other.id_;
  type_ = other.type_->clone();
  listfield_ = other.listfield_->clone();
...
DStructDer &DStructDer::operator=(const DStructDer & other)
{
  DStructDer tmp(other);
  swap(tmp);
  return *this;
}

void DStructDer::swap(DStructDer & other)
{
  std::swap(id_, other.id_);
  std::swap(type_, other.type_);
  std::swap(listfield_, other.listfield_);
...
void DStructDer::accept(Visitor *v)
{
  v->visitDStructDer(this);
}

DStructDer *DStructDer::clone() const
{
  return new DStructDer(*this);
}
...
/********************   STry    ********************/
STry::STry(Stm *p1, Type *p2, Id p3, Stm *p4)
{
  stm_1 = p1;
  type_ = p2;
  id_ = p3;
...
STry &STry::operator=(const STry & other)
{
  STry tmp(other);
  swap(tmp);
  return *this;
...
void STry::accept(Visitor *v)
{
  v->visitSTry(this);
}

STry *STry::clone() const
{
  return new STry(*this);
}
...
Type_exception::Type_exception(const Type_exception & other)
{

}

Type_exception &Type_exception::operator=(const Type_exception & other)
{
  Type_exception tmp(other);
  swap(tmp);
  return *this;
}

void Type_exception::swap(Type_exception & other)
{
...
void Type_exception::accept(Visitor *v)
{
  v->visitType_exception(this);
}

Type_exception *Type_exception::clone() const
{
  return new Type_exception(*this);
}
...
ListIdIn* consListIdIn(IdIn* x, ListIdIn* xs) {
  xs->insert(xs->begin(), x);
  return xs;
}
