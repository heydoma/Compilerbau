...
/* package llvm-test-0.1.0.0 */
#ifndef VERSION_llvm_test
#define VERSION_llvm_test "0.1.0.0"
#endif /* VERSION_llvm_test */
#ifndef MIN_VERSION_llvm_test
#define MIN_VERSION_llvm_test(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_llvm_test */
...
/* package llvm-hs-9.0.0 */
#ifndef VERSION_llvm_hs
#define VERSION_llvm_hs "9.0.0"
...
#define CURRENT_COMPONENT_ID "llvm-test-0.1.0.0-9DrUCt0QGdPAo63yYcCJ1S-toy"
